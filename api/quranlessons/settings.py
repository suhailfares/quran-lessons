"""
Django settings for quranlessons project.
...
SECRET_KEY = 'django-insecure-sy(%*&p$fa=2uyb_!)dzo^^1!yx*a!&0fe=!vu2*m70o+(3qn3'
...
ROOT_URLCONF = 'quranlessons.urls'
...
WSGI_APPLICATION = 'quranlessons.wsgi.application'
